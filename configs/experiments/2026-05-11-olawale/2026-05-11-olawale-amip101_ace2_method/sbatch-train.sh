...
#SBATCH --job-name=ace2style-ace-amip101
...
TRAINING_CONFIG=/pscratch/sd/o/olawale/E3SM_ace/ace/configs/experiments/2026-05-11-olawale-amip101_ace2_method/config-train-amip101.yaml
ACE_ROOT=/pscratch/sd/o/olawale/E3SM_ace/ace

# wandb config
export WANDB_NAME=amip101_training_ace2_method
